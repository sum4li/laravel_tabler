...
<html lang="en" dir="ltr">
	<head>
		...
		<script type="text/javascript" src="{{asset('backend/js/vendors/jquery-3.2.1.min.js')}}"></script>
		<script type="text/javascript" src="{{asset('backend/js/vendors/bootstrap.bundle.min.js')}}"></script>
